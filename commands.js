...
let embed_fields = [{
                name: "System info:",
                value: `${process.platform}-${process.arch} avec ${process.release.name} version ${process.version.slice(1)}`,
                inline: true
            },
            {
                name: "Information sur le processus: PID",
                value: `${process.pid}`,
                inline: true
            },
            {
            ...
            {
                name: "Utilisation de la mémoire du systeme:",
                value: `${Math.ceil((os.totalmem() - os.freemem()) / 1000000)} pour ${Math.ceil(os.totalmem() / 1000000)} MB`,
                inline: true
            },
            {
                name: "Uptime bot:",
